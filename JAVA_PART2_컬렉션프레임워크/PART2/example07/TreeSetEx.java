...
public class TreeSetEx {
	...
	public static void main(String[] args) {
		...
		// TreeSet은 이진트리를 기반으로 이루어진 컬렉션이며, 
		// Set인터페이스와 SortedSet인터페이스를 구현한 클래스이다. 
		...
		// 주어진 객체의 오른쪽에 있는 점수 -- 주어진 객체는 포함하지 않는다.
		score = scores.higher(95);
		System.out.println("95점 위의 점수 : " + score);
		// 주어진 객체의 오른쪽에 있는 점수 -- 주어진 객체는 포함한다.
		score = scores.ceiling(95);
		System.out.println("95점 위의 점수(95점도 포함) : " + score);
		System.out.println("남은 객체수 : " + scores.size());
		
//		while (!scores.isEmpty()) {
//			System.out.println("pollFist() 실행");
//			// 맨 왼쪽 객체부터 가져온다. 단, 가져온 후에 treeSet에서 제거를 한다.
...
//			// 맨 오른쪽 객체부터 가져온다. 단, 가져온 후에 treeSet에서 제거를 한다.
...
//		}
		...
		while (iterator.hasNext()) {
			// pollFirst(), pollLast() 메서드와 반복자의 가장 큰 차이점은 객체를 제거하느냐의 차이점이 있다.
			// 반복자에서는 명시적으로 remove() 호출해야 객체가 제거가 된다.
