...
public class PredicateAndOrNegateEx {
	...
	public static void main(String[] args) {
		...
		IntPredicate predicateA = x -> { return (x % 2) == 0; }; // 2의 배수를 구해서 확인하는 람다식
		IntPredicate predicateB = x -> { return (x % 3) == 0; }; // 3의 배수를 구해서 확인하는 람다식
		...
		System.out.println("9은 짝수입니까> " + predicateAB.test(9));
