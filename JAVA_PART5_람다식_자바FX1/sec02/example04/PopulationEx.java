...
public class PopulationEx {
	...
	public static void main(String[] args) {
		...
		// Function<T, R>을 이용해서 Population 객체를 주고, 지역을 리턴받게끔 하고 있다.
		Function<Population, String> function = t -> { return t.getRegion(); };
		regionPrint(function);
		
		// ToDoubleFunction<Population>을 이용하여 람다식으로 인구수를 리턴하게 만들고 있다.
	...
	public static void avgPrint(ToDoubleFunction<Population> toDoubleFunction) {
		...
		System.out.println();
		System.out.println("서울 평균 인구수 : " + (sum / populations.size()) + "명");
	}
