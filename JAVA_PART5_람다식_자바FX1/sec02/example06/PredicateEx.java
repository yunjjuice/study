...
public class PredicateEx {
	...
	public static void main(String[] args) {
		...
		// Predicate<T> 함수적 인터페이스는 test()의 추상메서드의 실체를 람다식으로 아래와 같이 익명구현했고
		// 남자이냐 여자이냐에 따라서 값이 달라짐을 역시 확인할 수가 있다.
	...
	// 아울러, 매개변수로 Predicate<Student>이다. 
	// 하여, 호출하는 곳에서는 Predicate<Student>의 추상메서드 test() 구현한 객체를 받아야 하는 것이다.
